								...
								<div className='d-flex justify-content-center'>
									<div className='d-flex flex-column justify-content-between' style={{ width: '100%', padding: '0.5rem' }}>
										...
										<p className='about-property-text' style={{ padding: '0.5rem' }}>
											3 acres of private Lake Superior beach front! Located on the North Country Trail. Muskallonge Lake located directly behind the property for great fishing. Hike or kayak on the
											famous Two-Hearted river. Parking for RV and 2 out buildings for snowmobile, ORV and boat parking. 9 miles from Pine Stump Junction. Captain's Guest House coming this spring!
										</p>
									</div>
								</div>
							</div>
