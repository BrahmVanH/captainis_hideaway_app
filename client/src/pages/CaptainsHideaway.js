					...
					<div className='rooms-and-beds-inner-container d-flex' style={{padding: '0.5rem'}}>
						...
						<div className='d-flex flex-row justify-content-between' style={{padding: '0.5rem', width: '100%', margin: '0.5rem'}}>
							<div>
								<p >Bedroom 1</p>
								<p >Icon</p>
								<p sstyle={{fontSize: '14px'}}>1 King Bed</p>
							</div>
							<div>
								<p >Bedroom 2</p>
								<p >Icon</p>
							...
							<div>
								<p style='margin: 0px;'>Common Area</p>
								<p style='margin: 0px;'>Icon</p>
								<p style='margin: 0px;font-size: 14px;'>2 Double Beds</p>
							</div>
						</div>
					</div>
				</div>
			...
			<div className='card' style={{ margin: '1rem', padding: '0.5rem' }}>
				<div className='card-body d-flex flex-column' style='padding: 0px;'>
					<div className='d-flex' style='padding: 0.5rem;'>
						<h1 style='font-size: 24px;padding: 0.5rem;margin: 0px;'>Spaces</h1>
			...
			<div className='card' style={{ margin: '1rem' }}>
				<div className='card-body d-flex flex-column' style={{ padding: '0.5rem' }}>
					<div className='d-flex' style={{ padding: '0.5rem' }}>
						...
						<div className='d-flex flex-column justify-content-center align-items-center' style='height: 100%;padding: 0.5rem 0rem;'>
